    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('stories.create')}}"><i class="fa fa-circle-o"></i>Qo'shish</a></li>
                    <li class=""><a href="{{route('stories.index')}}"><i class="fa fa-circle-o"></i> Ko'rish</a></li>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{route('booking.create')}}"><i class="fa fa-circle-o"></i>Qo'shish</a></li>
                    <li class=""><a href="{{route('booking.index')}}"><i class="fa fa-circle-o"></i> Ko'rish</a></li>
                </ul>
            </li>

            <li class="treeview">
                <a href="#">
                    <i class="fa fa-dashboard"></i> <span>Page Body</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{route('page-body.create')}}"><i class="fa fa-circle-o"></i>Qo'shish</a></li>
                    <li class=""><a href="{{route('page-body.index')}}"><i class="fa fa-circle-o"></i> Ko'rish</a></li>
                </ul>
            </li>

            <li><a href="{{route('contact.index')}}"><i class="fa fa-book"></i> <span>Contact</span></a></li>
            <li><a href="{{route('transport.index')}}"><i class="fa fa-book"></i> <span>Transport</span></a></li>
        </ul>
    </section>
    <!-- /.sidebar -->
</aside>

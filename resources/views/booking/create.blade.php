                ...
                <form role="form" action="{{route('booking.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Step 1" name="step1" placeholder="Enter Step 1">
                        </div>

                        <div class="form-group">
                            <label for="Step 2">Step 2</label>
                            <input type="text" class="form-control" id="Step 2" name="step2" placeholder="Enter Step 2">
                        </div>

                        <div class="form-group">
                            <label for="Step 3">Step 3</label>
                            <input type="text" class="form-control" id="Step 3" name="step3" placeholder="Enter Step 3">
                        </div>
